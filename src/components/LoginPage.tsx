...
const ClientLoginPage: FC = () => {
  const signIn = async () => {
    ...
    if (!credential?.accessToken) return toast.error("오류가 발생했습니다!")
    ...
    <div className="flex h-full flex-col items-center justify-center">
      <div className="w-full p-16 text-center">
        ...
        <button
          ...
          className="flex w-full flex-row items-center justify-center gap-x-3 rounded-lg bg-black px-4 py-2"
        >
          <svg
